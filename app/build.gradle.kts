...
android {
    namespace = "pl.kb.movie"
    compileSdk = 34

    defaultConfig {
        applicationId = "pl.kb.movie"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        ...
        buildConfigField("String", "ACCESS_TOKEN", sitProps.getProperty("ACCESS_TOKEN"))
        buildConfigField("String", "baseUrl", sitProps.getProperty("baseUrl"))
        buildConfigField("String", "databaseName", sitProps.getProperty("databaseName"))
        buildConfigField("String", "baseUrlThumbnail", sitProps.getProperty("baseUrlThumbnail"))
    }
